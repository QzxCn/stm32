...
void ledk()
{
	...
	LED_GPIO_Config();
/*modified through git here by test branch.but this sentence
 *was added in master
 *in branch test:now we see modifications in master showed in
 *test
 *master:last sentence,master靠縞at靠靠靠靠靠靠靠靠靠靠commit靠靠
 *master:
 * */	 
